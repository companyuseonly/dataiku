...
?>
    ...
    <div class="container-fullwidth background-gray padlr">
        <div class="container">
            <div class="six columns top80 bot40">
                <div class="circle-green-new"></div>
                <h2 class="circle-text">Our C.L.E.A.R. Values</h2>
            </div>
            <div class="six columns pad-top-100-careers bot40">
                <p class="top80 bot10-square-mobile">
                    At <?php echo $coName ?>, our C.L.E.A.R. values guide us: Client Delight drives our commitment to exceptional service and strong relationships; Leadership means acting with integrity and fostering positive change; Ethics ensures we put principles before profits; Aspiration inspires us to be the trusted partner adding real value; and Responsibility means owning our commitments and being accountable for results.
                </p>
    ...
    <div class="container-fullwidth background-gray square-fullwidth">
        <div class="container-80 top80">
            <!-- C -->
            <div class="four columns">
                <div class="row">
                    <div class="eleven-95 columns careers-square bot10-square-mobile">
                        <div class="hide-careers-square">
                            <!-- Replace with suitable SVG/icon for Client Delight -->
                            <img src="<?php echo $folderPath ?>assets/images/background/quality-of-life.png" alt="Client Delight" class="client-icon" />
                            <p class="careers-squre-heading font25 dark-blue">
                                Client Delight
                            </p>
                        </div>
                        <div class="show-careers-square">
                            <img src="<?php echo $folderPath ?>assets/images/background/quality-of-life.png"  class="client-icon" alt="Client Delight Hover" />
                            <p class="square-hover-font-size">
                                We are focused on always delivering genuine exceptional services to our clients as our success drives from our deep commitment and relationship with them.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="four columns">
                <div class="row">
                    <div class="eleven-95 columns careers-square bot10-square-mobile">
                        <div class="hide-careers-square">
                            <!-- Replace with suitable SVG/icon for Leadership -->
                            <img src="<?php echo $folderPath ?>assets/images/background/leadership.png"   class="client-icon" alt="Leadership" />
                            <p class="careers-squre-heading font25 dark-blue">
                                Leadership
                            </p>
                        </div>
                        <div class="show-careers-square">
                            <img src="<?php echo $folderPath ?>assets/images/background/leadership.png"   class="client-icon" alt="Leadership Hover" />
                            <p class="square-hover-font-size">
                                We lead with integrity, using facts to support our straight talk, and create an environment for positive change.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="four columns">
                <div class="row">
                    <div class="eleven-95 columns careers-square bot10-square-mobile">
                        <div class="hide-careers-square">
                            <!-- Replace with suitable SVG/icon for Ethics -->
                            <img src="<?php echo $folderPath ?>assets/images/background/management.png"   class="client-icon" alt="Ethics" />
                            <p class="careers-squre-heading font25 dark-blue">
                                Ethics
                            </p>
                        </div>
                        <div class="show-careers-square">
                            <img src="<?php echo $folderPath ?>assets/images/background/management.png"   class="client-icon" alt="Ethics Hover" />
                            <p class="square-hover-font-size">
                                We insist on putting principles before profits and behave in the most ethical way with our clients, partners, and our people alike.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fullwidth background-gray square-fullwidth-neg-margin">
        <div class="container-80 bot40">
            <!-- A -->
            <div class="four columns">
                <div class="row">
                    <div class="eleven-95 columns careers-square top15 bot80">
                        <div class="hide-careers-square">
                            <!-- Replace with suitable SVG/icon for Aspiration -->
                            <img src="<?php echo $folderPath ?>assets/images/background/aspirating.png"   class="client-icon" alt="Aspiration" />
                            <p class="careers-squre-heading font25 dark-blue">
                                Aspiration
                            </p>
                        </div>
                        <div class="show-careers-square">
                            <img src="<?php echo $folderPath ?>assets/images/background/aspirating.png"   class="client-icon" alt="Aspiration Hover" />
                            <p class="square-hover-font-size">
                                We aspire, individually and collectively, to become the go-to partner for our clients by adding value to their business across all areas of our service offerings.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="four columns">
                <div class="row">
                    <div class="eleven-95 columns careers-square top15 bot80">
                        <div class="hide-careers-square">
                            <!-- Replace with suitable SVG/icon for Responsibility -->
                            <img src="<?php echo $folderPath ?>assets/images/background/accountability.png"   class="client-icon" alt="Responsibility" />
                            <p class="careers-squre-heading font25 dark-blue">
                                Responsibility
                            </p>
                        </div>
                        <div class="show-careers-square">
                            <img src="<?php echo $folderPath ?>assets/images/background/accountability.png"   class="client-icon" alt="Responsibility Hover" />
                            <p class="square-hover-font-size">
                                We accept full responsibility of our commitments and drive to excel, and expect to be accountable for results of our actions.
                            </p>
                        </div>
                    </div>
                </div>
