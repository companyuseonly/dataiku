...
<section data-bg="<?php echo $folderPath ?>assets/images/background/4637.jpg" class="page-title js-color-change rocket-lazyload" style="">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <ul>
                ...
                <li class="post post-page current-item"><span class="post post-page current-item">Our <?php echo $thisPage ?></span></li>
            </ul>
        </div>
    </div>
    <!--breadcrumbs-->
    ...
    <div class="container">
        <div class="holder">
            <h1 class="bot20">Our <?php echo $thisPage ?></h1>
...
<?php $clientMode = "2"; include($folderPath . "Components/clients.php"); ?>
